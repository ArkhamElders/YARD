...
**Podczas walki:** Szaman poświęca liczbę punktów [DET] równą połowie poziomu rzucanego zaklęcia. Następnie kreśli na ziemi magiczny krąg, w którym dzięki modlitwie kumuluje się pradawna energia. Jeśli rzut się powiedzie, bóstwo błogosławi szamana podwajając wynik obrażeń / leczenia.
...
**Podczas walki:** Pieśń barda może zagrzewać towarzyszy do boju, dając im kość premiową. Może także skutecznie utrudniać koncentrację przeciwnikom drużyny (kość karna). Wystarczy, że Bohater zadeklaruje rodzaj pieśni i poświęci 1 pkt [DET], aby wspomóc towarzyszy lub osłabić wroga.
